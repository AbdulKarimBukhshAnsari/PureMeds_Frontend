  ...
  return (
    <>
      <div className="bg-background">
        {submitted ? (
          <>
            <div className="min-h-screen bg-background flex justify-center items-start py-40 px-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm opacity-90">
                        Help us combat fake medicines by reporting suspicious
                        products
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="flex">
                      ...
                      <div>
                        <p className="text-sm text-blue-700">
                          ...
                          the suspected counterfeit medicine. Your report will
                          be kept confidential and will help protect others.
                        </p>
                      </div>
                    </div>
                  </div>

                  <ComplaintForm onSubmitForm={handleFormSubmit} />
                </div>
              </div>
            </div>
          </>
